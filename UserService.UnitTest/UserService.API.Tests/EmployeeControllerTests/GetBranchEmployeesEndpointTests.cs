...
public class GetBranchEmployeesEndpointTests
{
    private readonly Mock<IMediator> _mockMediator;
    private readonly Mock<ILogger<EmployeeController>> _mockLogger;
    private readonly EmployeeController _employeeController;

    public GetBranchEmployeesEndpointTests()
    {
    ...
    [Fact]
    public async Task Should_Return_BranchEmployees_WithOkStatusCode()
    {
        ...
        // Act
        var result = await _employeeController.GetBranchEmployees(1,1,1);
