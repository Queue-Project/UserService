...
public class CreateEmployeeRoleRequestValidatorTests
{
     private readonly CreateEmployeeRoleRequestValidator _validatorTests;

    public CreateEmployeeRoleRequestValidatorTests()
    {
        _validatorTests = new CreateEmployeeRoleRequestValidator();
    }
    ...
    {
        //Arrange
        var command = new CreateEmployeeRoleRequest
        {
           ServiceId = 1, 
